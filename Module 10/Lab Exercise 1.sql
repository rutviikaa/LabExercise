...
BEGIN
	...
	RETURN CASE LEN(@Digits)
		...
		WHEN 7 THEN SUBSTRING (@Digits,1,3)+ N'-' + SUBSTRING (@Digits,4,4) 
		WHEN 6 THEN SUBSTRING (@Digits,1,3)+ N'-' + SUBSTRING (@Digits,4,3)
		ELSE @Digits
	END;
END;
GO

SELECT dbo.FormatPhoneNumber ('+91-9874598')
SELECT dbo.FormatPhoneNumber ('(91)-98745981')
SELECT dbo.FormatPhoneNumber ('98745989')
SELECT dbo.FormatPhoneNumber ('9874598')
SELECT dbo.FormatPhoneNumber ('987459')